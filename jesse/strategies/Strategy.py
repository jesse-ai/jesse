...
class Strategy(ABC):
    ...
    @property
    def current_candle_timestamp(self) -> int:
        """
    ...
    def hlc3(self) -> float:
        ...
        """
        return utils.sum_floats(
            utils.sum_floats(self.current_candle[3], self.current_candle[4]), self.current_candle[2]
        ) / 3
    ...
    def ohlc4(self) -> float:
        ...
        """
        return (self.current_candle[1] + self.current_candle[2] + self.current_candle[3] + self.current_candle[3]) / 4
