...
def anchor_timeframe(timeframe: str) -> str:
    ...
    dic = {
        Timeframe.MINUTE_1.value: Timeframe.MINUTE_5.value,
        Timeframe.MINUTE_3.value: Timeframe.MINUTE_15.value,
        Timeframe.MINUTE_5.value: Timeframe.MINUTE_30.value,
        Timeframe.MINUTE_15.value: Timeframe.HOUR_2.value,
        Timeframe.MINUTE_30.value: Timeframe.HOUR_3.value,
        Timeframe.MINUTE_45.value: Timeframe.HOUR_3.value,
        Timeframe.HOUR_1.value: Timeframe.HOUR_4.value,
        Timeframe.HOUR_2.value: Timeframe.HOUR_6.value,
        Timeframe.HOUR_3.value: Timeframe.DAY_1.value,
        Timeframe.HOUR_4.value: Timeframe.DAY_1.value,
        Timeframe.HOUR_6.value: Timeframe.DAY_1.value,
        Timeframe.HOUR_8.value: Timeframe.DAY_1.value,
        Timeframe.HOUR_12.value: Timeframe.DAY_1.value,
    }
...
def timeframe_to_one_minutes(timeframe: str) -> int:
    ...
    try:
        ...
        all_timeframes = [timeframe for timeframe in jh.class_iter(Timeframe)]
