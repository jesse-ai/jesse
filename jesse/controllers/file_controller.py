...
from jesse.services.web import GetApiKeys
router = APIRouter(prefix="/download", tags=["Download"])


@router.post("/download-api-keys")
def download_api_keys(request_json: GetApiKeys, authorization: Optional[str] = Header(None)):
    """
    Download API Keys
    """
    ...
    return data_provider.download_api_keys(request_json.exchange, request_json.name)
