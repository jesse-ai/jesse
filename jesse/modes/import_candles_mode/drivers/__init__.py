...
from jesse.modes.import_candles_mode.drivers.MEXC.MEXCPerpetualFutures import MEXCPerpetualFutures
...
drivers = {
    ...
    exchanges.MEXC_PERPETUAL_FUTURES: MEXCPerpetualFutures,
