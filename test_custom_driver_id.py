#!/usr/bin/env python3
"""
Test CustomCSV driver with id field
"""
...
def test_custom_driver_id():
    """Test CustomCSV driver with id field"""
    print("🧪 Тест CustomCSV driver с полем id")
    print("=" * 50)
            ...
            try:
                ...
                if candles:
                    ...
                    if isinstance(candles[0], dict):
                        ...
                        required_keys = ['id', 'timestamp', 'open', 'close', 'high', 'low', 'volume', 'symbol', 'exchange', 'timeframe']
                        ...
                        if candles[0]['id'] is not None:
                            print(f"   ✅ ID не пустой")
                        else:
                            print(f"   ❌ ID пустой")
                    else:
