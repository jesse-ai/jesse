...
def test_routes():
    # re-define routes
    router.set_routes([
        {'exchange': Exchanges.BITFINEX_SPOT, 'symbol': 'ETH-USD', 'timeframe': Timeframe.HOUR_3, 'strategy': 'Test19'},
        {'exchange': Exchanges.SANDBOX, 'symbol': 'BTC-USD', 'timeframe': Timeframe.MINUTE_15, 'strategy': 'Test19'},
    ])

    router.set_data_candles([
        {'exchange': Exchanges.BITFINEX_SPOT, 'symbol': 'EOS-USD', 'timeframe': Timeframe.HOUR_3},
        {'exchange': Exchanges.BITFINEX_SPOT, 'symbol': 'EOS-USD', 'timeframe': Timeframe.HOUR_1},
    ])
    ...
    assert set(config['app']['trading_timeframes']) == set([Timeframe.HOUR_3, Timeframe.MINUTE_15])
    ...
    assert set(config['app']['considering_timeframes']) == set(
        [Timeframe.MINUTE_1, Timeframe.HOUR_3, Timeframe.MINUTE_15, Timeframe.HOUR_1])
