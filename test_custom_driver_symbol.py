#!/usr/bin/env python3
"""
Test CustomCSV driver with symbol field
"""
...
def test_custom_driver_symbol():
    """Test CustomCSV driver with symbol field"""
    print("🧪 Тест CustomCSV driver с полем symbol")
    print("=" * 50)
            ...
            try:
                ...
                if candles:
                    ...
                    if isinstance(candles[0], dict):
                        ...
                        required_keys = ['timestamp', 'open', 'close', 'high', 'low', 'volume', 'symbol']
